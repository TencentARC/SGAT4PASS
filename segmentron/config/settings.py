...
cfg.AUG.MIRROR = True
# random scale
cfg.AUG.RESCALE = True
# reprojection
cfg.AUG.REPROJECTION = False
cfg.AUG.X_MAX = 10
cfg.AUG.Y_MAX = 10
cfg.AUG.Z_MAX = 360
# REPROJECT_PADDING 
cfg.AUG.REPROJECT_PADDING = False
# blur probability
...
# line loss weght
cfg.SOLVER.OFFSET_LINE_WEIGHT = None
# axis loss weght
cfg.SOLVER.OFFSET_AXIS_WEIGHT = None
# Per Pixel loss Weight
cfg.SOLVER.PER_PIXEL_WEIGHT = None
cfg.SOLVER.PER_PIXEL_NORM = False
########################## test config ###########################################
# val/test model path
...
cfg.TEST.FLIP = False
# rotation test
cfg.TEST.RANDOMRATATION = (5,5,360)
cfg.TEST.RANDOMDIR = 'datasets/test_data/'
cfg.TEST.SGA = False
cfg.TEST.ROTATIONS = [(0,0,0),(0,0,90),(0,0,180),(0,0,270),(5,0,0),(5,0,90),(5,0,180),(5,0,270),(0,5,0),(0,5,90),(0,5,180),(0,5,270),(5,5,0),(5,5,90),(5,5,180),(5,5,270)]
