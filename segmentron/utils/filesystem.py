...
def save_checkpoint(args, model, epoch, optimizer=None, lr_scheduler=None, is_best=False, fold=1, save_last=False):
    """Save Checkpoint"""
    ...
    if is_best:
        best_filename = 'best_model_fold_{}.pth'.format(fold)
